      ...
      <footer className="border-t border-line h-[7%] w-full flex sm:justify-between z-10 bg-primary relative">
        <div className="flex">
          <div
            ...
            className="px-4 py-3 md:py-2 cursor-link flex-1 border-r border-line button-hover h-full cursor-pointer hover:opacity-80 transition-opacity"
          >
          ...
          <div className="flex justify-center items-center flex-1">
            <a
              ...
              target="_blank"
              className={`px-4 py-3 md:py-2 cursor-link flex-1 border-r border-line button-hover h-full`}
            >
        ...
        >
          ...
          <div className="flex flex-col gap-6 flex-1 ">
            ...
            <div
              ...
              className="flex gap-2 items-center justify-between cursor-pointer button-hover p-2 transition-opacity rounded"
            >
